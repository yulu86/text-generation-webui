...
python server.py --listen-host text.com --listen-port 7860 --character Assistant --auto-devices --extensions text-gen-webui-ui_tweaks long_replies webui_tavernai_charas superboogav2 --trust-remote-code --model THUDM_chatglm3-6b
```
