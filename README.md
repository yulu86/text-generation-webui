...
python server.py --listen --character Assistant --auto-devices --extensions text-gen-webui-ui_tweaks Emotivoice_TTS long_replies webui_tavernai_charas superboogav2 --trust-remote-code --model baichuan-inc_Baichuan2-7B-Chat
```
